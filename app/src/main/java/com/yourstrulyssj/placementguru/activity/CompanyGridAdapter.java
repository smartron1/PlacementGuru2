...
public class CompanyGridAdapter extends BaseAdapter {
    ...
    public CompanyGridAdapter(Context context, ArrayList<String> images, ArrayList<String> names){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = layoutInflater.inflate(R.layout.companylayout,parent,false);
