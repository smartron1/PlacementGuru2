...
public class LoginActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnForm = (Button) findViewById(R.id.linkForm) ;
        btnEnroll = (Button) findViewById(R.id.linkEnroll);
        ...
        btnForm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(LoginActivity.this,alumnaeFeedback.class);
                startActivity(i);
            }
        });
        ...
        btnEnroll.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(LoginActivity.this,AlumnaeEnroll.class);
                startActivity(i);
            }
        });
