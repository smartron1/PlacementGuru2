...
import static com.yourstrulyssj.placementguru.app.AppConfig.c1;
...
public class company extends AppCompatActivity
    ...
    public static final String DATA_URL = c1;
    ...
    private void showGrid(JSONArray jsonArray){
        ...
        for(int i = 0; i<jsonArray.length(); i++){
            ...
            try {
                ...
                description.add(obj.getString(TAG_DESC));
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent i1 = new Intent(getApplicationContext(),company_Profile.class);
                i1.putExtra("url",url);
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(company.this, LoginActivity.class);
